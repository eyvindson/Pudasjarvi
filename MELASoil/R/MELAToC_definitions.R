...
ADD = substr(args[1],start=1,stop = nchar(args[1])-4)
MineralSoilSouth <- paste(IntermediateLitterDir,"sf_min",ADD,".dat", sep="")
MineralSoilNorth <- paste(IntermediateLitterDir,"nf_min",ADD,".dat", sep="")
OrganicSoilAboveSouth  <- paste(IntermediateLitterDir,"sf_org_abv",ADD,".dat", sep="")
OrganicSoilAboveNorth  <- paste(IntermediateLitterDir,"nf_org_abv",ADD,".dat", sep="")
OrganicSoilBelowSouth  <- paste(IntermediateLitterDir,"sf_org_bel",ADD,".dat", sep="")
OrganicSoilBelowNorth  <- paste(IntermediateLitterDir,"nf_org_bel",ADD,".dat", sep="")
