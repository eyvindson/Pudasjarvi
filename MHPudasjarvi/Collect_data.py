...
mypath = "/scratch/project_2003225/GIT/Yasso/Output_files_Yasso/"#PUDASJARVI_P30061_2010_2060/"
...
write_df(df_final_co2,'/scratch/project_2003225/temp2b.txt','w')
ll = 0
for fname in ls_all:#[0:10000]:
    ...
    write_df(df_co2,'/scratch/project_2003225/temp2b.txt','a')
