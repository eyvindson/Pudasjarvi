...
def Mapping(TT):    
    ...
    data = {'x': t_lon, 'y' : t_lat, 'DEC_LAI': Mean_LAI_dec, 'CON_LAI': MEAN_LAI_conf} 
    k = 0
    Mean_GWT = []
...
def N2O_CH4_C2O_EMISSIONS(GTW,peat_loc,region,duplicate_part,file_start,DD,UPFERT):
    ...
    EM_data = {"Segment":df1[0],"LAI_DEC":GTW['DEC_LAI'], "LAI_CON":GTW['CON_LAI'],"Pixels":t_PIXELS['Segment'],"Depth":t_Depth['Segment'],"Ditch":t_Drain['Segment']}
    k = 0
    for i in key:
