...
#”df=forecast_yr(60.22, 24.77)” hakee vuorokausi ennusteen Kiloon 10 päiväksii
#ja ”df=forecast_yr(60.22, 24.77, hourly=True)” 48 tunnin ennusteen.
if __name__ == "__main__":
    ...
    parser.add_argument('-w','--hourly',dest='h',action="store_true",help='If option present (true), 48 hour forecast')
    parser.add_argument('-p','--proxy',dest='p',action="store_true",help='If option present (true), Luke proxies required in Luke')
    args = parser.parse_args()
    print(args.h,args.p)
    df = forecast_yr(args.x,args.y,hourly=args.h,proxy=args.p)
